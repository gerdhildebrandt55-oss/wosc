...
<head>
  ...
  <title>Fire Crystal Furnace – Upgrade-Tabelle | Kompendium</title>
...
<body>
  <div class="wrap">
    <header class="mast">
      <div class="brand-block">
        <a href="../index.html" class="brand" style="color:inherit;text-decoration:none">
          ...
          <div>
            <div class="brand-title">Kompendium</div>
            <div class="brand-sub">Strategie · Daten · Rechner</div>
          </div>
        </a>
      </div>
    ...
    <div class="layout">
      <aside class="navcol" aria-label="In diesem Bereich">
        <h2>Inhalt</h2>
        <ul>
          <li><a href="../index.html">Kompendium</a></li>
          <li><a href="index.html">Building · Gebäude</a></li>
...
{tbody}
        ...
        <footer class="foot">
          ...
          <a href="/">Startseite</a> · <span data-y></span>
        </footer>
        </div>
      </main>
    </div>
